...
const MissionSection = () => {
  ...
  return (
    <div className="py-24 bg-gray-100">
      ...
      <div className="grid md:grid-cols-3 gap-12 md:gap-16 mb-16 px-6">
        {missions.map((mission, index) => (
          <div key={index} className="flex flex-col items-center bg-white p-6 rounded-lg shadow-lg transform transition-all hover:scale-105 hover:shadow-xl">
            <div className="mb-4">{mission.icon}</div>
            <h3 className="text-2xl font-semibold text-gray-800 mb-2">{mission.title}</h3>
